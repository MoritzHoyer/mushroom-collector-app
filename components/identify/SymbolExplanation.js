...
const SymbolExplanation = () => {
    return (
        <ExplanationContainer>
            ...
            <WarningText>
                When picking mushrooms, it is in your own interest to exercise
                the greatest possible caution. In order to be able to identify a
                mushroom with certainty, not only the picture but also each of
                the described characteristics must be compared with the mushroom
                found. If there is the slightest doubt about the identity of a
                mushroom, the find should be presented to a mushroom expert or a
                mushroom advisory center for examination.
            </WarningText>
            <Divider />
            <ExplanationTitle>Explanation of symbols</ExplanationTitle>
            <SymbolRow>
                <SymbolIcon
                    src="./icons/deadly-toxic-icon.svg"
                    alt="Deadly poisonous"
                />
